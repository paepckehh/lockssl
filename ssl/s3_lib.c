...
/*
 * The list of known Signaling Cipher-Suite Value "ciphers", non-valid
 * values stuffed into the ciphers field of the wire protocol for signaling
 * purposes.
 */
...
# endif
    ...
    if (SSL_IS_TLS13(s)) {
         ...
         * TLSv1.3 spec). Therefore we should prioritize ciphersuites using
         * that.
         */
